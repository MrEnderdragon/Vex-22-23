...
signature aimVision__BLUE_GOAL = signature (2, -2461, -1265, -1864, 3011, 6585, 4798, 1.9, 0);
vision aimVision = vision (PORT13, 63, aimVision__RED_GOAL, aimVision__BLUE_GOAL);
